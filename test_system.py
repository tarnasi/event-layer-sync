...
def test_api():
    ...
    with httpx.Client() as client:
        ...
        response = client.get(f"{BASE_URL}/ping", headers=headers)
        ...
        response = client.post(f"{BASE_URL}/warehouses/", 
                              json=warehouse_data, 
                              headers=headers)
        ...
        response = client.put(f"{BASE_URL}/shipments/{shipment_id}", 
                             json=update_data, 
                             headers=headers)
        ...
        response = client.get(f"{BASE_URL}/warehouses/", headers=headers)
        ...
        response = client.get(f"{BASE_URL}/shipments/", headers=headers)
